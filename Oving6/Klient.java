...
public class Klient {
    ...
    public static void main(String[] args) throws Exception {
        /*
        Oppgave 1:
        Optimistisk låsing er en løsning på problemet med at to klienter forsøker å endre en verdi samtidig.
        I denne øvingen for eksempel prøver vi i oppgave 3 å la to klienter leser en saldo og legger til 100kr.
        Saldoen blir kun økt med 100kr, men skulle i utgangspunktet blitt økt med 200kr.
        Løsningen på dette er optimistisk låsing der man legger til et ekstra felt i databasen som
        oppdateres hver gang noen skriver til databaseraden.
        Dermed kan man se om noen har oppdatert raden etter at en klient leste ut verdiene.
        EntityManager vil alltid sjekke dette feltet ved lagring. Om to klienter prøver å endre samtidig
        vil EntityManager hive en OptimisticLockException.
        */
        oppgave2();
        oppgave3();
        oppgave4();
    ...
    public static void oppgave2() {
        EntityManagerFactory EMF = Persistence.createEntityManagerFactory("Oving6");
        KontoDAO dao = new KontoDAO(EMF);

        // Opprett to kontoer og lagre til databasen
        Konto konto1 = new Konto();
        konto1.setKontonr(1);
        konto1.setEier("Student");
    ...
    public static void oppgave3() throws Exception {
        ...
        thread.join();
        System.out.println("\n Oppgave 3 \n");
        System.out.println("Ønskelig resultat: Konto 1, saldo 800. Konto 2, saldo 700");
    ...
    public static void oppgave4() throws Exception {
        ...
        KontoDAO dao = new KontoDAO(entityManagerFactory);
         ...
         konto1.setEier("Lars Sørlie"); konto1.setSaldo(1000); dao.lagreNyKontoLocked(konto1);
